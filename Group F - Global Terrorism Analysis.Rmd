...
```{r}
setwd("~/IE-BIGDATA/Term 1/R-statistics/Assignment")
...
#p<0.05 for all models so we REJECT H0, atleast two SSE's are different. 
```
...
##3.3 predicting future terrorist attack amounts
